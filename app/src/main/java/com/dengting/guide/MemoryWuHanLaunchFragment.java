...
/**
 * Created by dengting on 16/9/27.
 */

public class MemoryWuHanLaunchFragment extends LauncherBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        View rooView=inflater.inflate(R.layout.fragment_wuhan_launcher, null);
