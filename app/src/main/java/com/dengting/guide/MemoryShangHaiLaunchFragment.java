...
/**
 * Created by dengting on 16/9/28.
 *
 * @author dengting
 *
 * 上海回忆
...
public class MemoryShangHaiLaunchFragment extends LauncherBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rooView=inflater.inflate(R.layout.fragment_shanghai_launcher, null);
    ...
    private void loveForYouAnimation(){
